    ...
    return ( 
        <div className="navbar sticky">
            <div className="navbar__cont">
                ...
                <div className="navbar__pdf"><button className="navbar__button"><a className="navbar__link" href="KatjaZenkerCV2022.pdf" target="_blank" download="KatjaZenkerCV2022.pdf">Download CV</a></button></div>
